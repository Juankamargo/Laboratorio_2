...
public class Ejecicio_Banco {
    ...
    public static void main(String[] args) {
        ...
        while(true)
        {
            ...
            {
                case 1:
                    System.out.println("1.Cuenta de ahorros\t2.Cheuqes");
                    ...
                    switch(option1)
                    {
                        case 1:
                            ...
                            System.out.println("Mes(numero):\t "); int month = read.nextInt();
                            System.out.println("Dia(numero):\t "); int day = read.nextInt();
                            if(100>=year && 12>=month && 31>=day &&year>0&&month>0&&day>0)
                            {
                            ...
                            Account newAccount = new Savings(dueDate,taxPercentage,accountNumber,clientName,balance);
                        ...
                        case 2:
                            ...
                            System.out.println("Inserte nombre del cliente:\t "); String clientName = read.next();
                            System.out.println("Inserte nuevo saldo:\t "); double balance = read.nextDouble();
                            Account newAccount = new Check(commissionForUse,commissionChecksWithoutFounds,accountNumber,clientName,balance);
                            accounts.put(clientName,newAccount); 
                            break;
                    }
                    break;
